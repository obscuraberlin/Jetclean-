...
export function VideoEmbed({
  ...
  return (
    <div
      className={cn(
        'relative aspect-video overflow-hidden rounded-3xl bg-navy-950 shadow-lift',
        className,
      )}
    >
      {active ? (
        ...
        <>
          ...
          <p
            id={noticeId}
            className="absolute inset-x-0 bottom-0 px-4 py-3 text-center text-[0.6875rem] leading-relaxed text-white/75 sm:px-8 sm:text-xs"
          >
